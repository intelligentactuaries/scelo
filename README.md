...
Note the channels and platforms are not in lockstep: the apt repository above
serves **0.1.4**, the Releases tab has **0.1.3** for Linux and **0.1.2** for
Windows, and **macOS has no build yet** — see
