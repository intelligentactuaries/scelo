...
const OP_ALIASES: Record<string, CleaningOpKey> = {
  ...
  // imputation — note these are the FILL aliases; "missing-tokens" above
  // covers the opposite direction (turning "N/A" text INTO a null).
  impute: "impute-missing",
  imputation: "impute-missing",
  "impute-missing-values": "impute-missing",
  "fill-missing": "impute-missing",
  "fill-nulls": "impute-missing",
