...
TOOLS   life      sc.life_table()  sc.commutation(i=.04)  sc.factors(i=.04,n=10)  sc.premium()
                  ...
                  sc.scr_life(mp)  sc.csm(mp, ra=.05)  sc.lifelib_run("basiclife", "BasicTerm_ME", mp)
        ...
        pricing   sc.glm(df,"claims ~ C(region)+age","poisson",offset="exposure",base="first")  .relativities()
